...
const CASES: Record<RuleOperator, Case[]> = {
  EQUAL: [
    ...
    { compare: { en: 'Active' }, actual: 'Active', expected: true, why: 'object vs scalar text matching' },
    { compare: 'Active', actual: { en: 'Active' }, expected: true, why: 'scalar text vs object matching' },
    { compare: { en: 'Active' }, actual: { en: 'Inactive' }, expected: false, why: 'different object values' },
  ],
  NOT_EQUAL: [
  ...
  CONTAINS: [
    ...
    { compare: { en: 'Active' }, actual: [{ en: 'Active' }, { en: 'Inactive' }], expected: true, why: 'object member in array' },
    { compare: 'Active', actual: [{ en: 'Active' }], expected: true, why: 'scalar in object-valued array' },
    { compare: { en: 'Pending' }, actual: [{ en: 'Active' }], expected: false, why: 'absent object member in array' },
  ],
  NOT_CONTAINS: [
    ...
    { compare: { en: 'Pending' }, actual: [{ en: 'Active' }], expected: true, why: 'absent object member in array' },
    { compare: { en: 'Active' }, actual: [{ en: 'Active' }], expected: false, why: 'present object member in array' },
  ],
  STARTS_WITH: [
  ...
  IN: [
    ...
    { compare: [{ en: 'Active' }, { en: 'Pending' }], actual: { en: 'Active' }, expected: true, why: 'object value in list of target options' },
    { compare: ['Active', 'Pending'], actual: { en: 'Active' }, expected: true, why: 'object value in scalar list' },
    { compare: [{ en: 'Active' }], actual: { en: 'Inactive' }, expected: false, why: 'object value not in list' },
  ],
  NOT_IN: [
